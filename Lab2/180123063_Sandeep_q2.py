...
def func_set1(S0,K,T,m,r,sigma):
    ...
    for k in range(0,2**m):
        ...
        for i in range(1,m+1):
            ...
            price.append(xx)
        Savg = np.mean(price)
        put_payoff = max(K-Savg,0)
        call_payoff = max(Savg-K,0)
        put_option_price += math.pow(p,cnt) * math.pow((1-p),m-cnt) * put_payoff
        call_option_price += math.pow(p,cnt) * math.pow((1-p),m-cnt) * call_payoff
...
print("For Set-1")
c1,c2 = func_set1(100,100,1,10,0.08,0.20)
print("Asian Call Option Price =","{:.8f}".format(c1))
print("Asian Put Option Price =","{:.8f}".format(c2))
print("For Set-2")
c1,c2 = func_set2(100,100,1,10,0.08,0.20)
print("Asian Call Option Price =","{:.8f}".format(c1))
print("Asian Put Option Price =","{:.8f}".format(c2))
...
for x in S0_arr:
    x1,x2 = func_set1(x,100,1,10,0.08,0.20)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in S0_arr:
    x1,x2 = func_set2(x,100,1,10,0.08,0.20)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in K_arr:
    x1,x2 = func_set1(100,x,1,10,0.08,0.20)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in S0_arr:
    x1,x2 = func_set2(100,x,1,10,0.08,0.20)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in r_arr:
    x1,x2 = func_set1(100,100,1,10,x,0.20)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in r_arr:
    x1,x2 = func_set2(100,100,1,10,x,0.20)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in s_arr:
    x1,x2 = func_set1(100,100,1,10,0.08,x)
    put_arr.append(x2)
    call_arr.append(x1)
...
for x in s_arr:
    x1,x2 = func_set2(100,100,1,10,0.08,x)
    put_arr.append(x2)
    call_arr.append(x1)
...
for xx in x:
    for yy in y:
        zz1 = func_set1(xx,yy,1,10,0.08,0.2)
...
for xx in x:
    for yy in y:
        zz1 = func_set2(xx,yy,1,10,0.08,0.2)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set1(xx,100,1,10,yy,0.2)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set2(xx,100,1,10,yy,0.2)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set1(xx,100,1,10,0.08,yy)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set2(xx,100,1,10,0.08,yy)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set1(100,xx,1,10,yy,0.2)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set2(100,xx,1,10,yy,0.2)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set1(100,xx,1,10,0.08,yy)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set2(100,xx,1,10,0.08,yy)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set1(100,100,1,10,xx,yy)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
...
for xx in x:
    for yy in y:
        zz1 = func_set2(100,100,1,10,xx,yy)
        ax.scatter(xx,yy,zz1[0],c='g',linewidths=0.5)
        ax.scatter(xx,yy,zz1[1],c='r',linewidths=0.5)
